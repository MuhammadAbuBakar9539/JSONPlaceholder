...
import com.example.jsonplaceholder.presenter.PostsPresenter;
import com.example.jsonplaceholder.recycler_view.JsonPostsAdapter;

import java.util.List;

public class PostsFragment extends Fragment implements JsonPlaceholderContract.PostsView {

    private JsonPlaceholderContract.PostsPresenter presenter;
    ...
    @Override
    public void showPosts(List<JsonPostsModel> jsonPostsModel) {
        JsonPostsAdapter postsAdapter = new JsonPostsAdapter(jsonPostsModel);
    ...
    public void onDestroy() {
        presenter.onPostsDestroyCalled();
        super.onDestroy();
    }
}
